...
export async function GET(
  ...
  try {
    ...
    const { data: minutes, error: minutesError } = await minutesQuery.order('serial_no', { nullsFirst: false }).order('minute_order', { nullsFirst: false });
    ...
    const actionItems = (minutes || []).map(minute => ({
      ...
      flags: minute.flags,
      is_done: minute.is_done,
      toggled_by: minute.toggled_by,
      toggled_at: minute.toggled_at,
      completed_at: minute.completed_at,
      completed_by_name: minute.completed_by_name,
      created_by_name: minute.created_by_name,
      updated_by_name: minute.updated_by_name,
